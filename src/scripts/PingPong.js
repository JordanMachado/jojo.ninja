...
float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
          ...
          void main() {
            ...
            pos.y /= 256.;
            pos.z /= 256.;
            pos.x += pnoise(pos.xyz + uTime,vec3(0., 10. , 10.));
            gl_FragColor = pos;
          }
          `, this.uniforms);
        ...
        // this.fboIn = new PIXI.FrameBuffer(width, height);
        // this.fboOut = new PIXI.FrameBuffer(width, height);
        this.fboIn = new PIXI.RenderTexture.create(width, height, PIXI.SCALE_MODES.LINEAR, 2);

        console.log(this.fboIn);
        this.fboOut = new PIXI.RenderTexture.create(width, height, PIXI.SCALE_MODES.LINEAR, 2);

        this.fboOutO = this.fboOut;

        this.renderer.render(this.quad, this.fboIn);
        this.renderer.render(this.quad, this.fboOut);
    ...
    update()
    {
        ...
        this.quad.shader.uniforms.uTexture = this.fboIn;
        this.renderer.render(this.quad, this.fboOut);
    }
}
